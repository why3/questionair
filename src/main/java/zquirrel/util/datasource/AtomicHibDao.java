 ...
 *            the entity.
 */
public class AtomicHibDao<T extends Serializable> implements HibDao<T> {

	// the log.
	private final static Log log = LogFactory.getLog(AtomicHibDao.class);
	 ...
	 *            the entity class.
	 */
	public AtomicHibDao(Class<T> clazz) {
		this.clazz = clazz;
	}

	/* (non-Javadoc)
	 * @see zquirrel.util.datasource.HibDao#find(org.hibernate.criterion.Criterion)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see zquirrel.util.datasource.HibDao#list(org.hibernate.criterion.Criterion)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see zquirrel.util.datasource.HibDao#list(org.hibernate.criterion.Criterion, int, int)
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/* (non-Javadoc)
	 * @see zquirrel.util.datasource.HibDao#count(org.hibernate.criterion.Criterion)
	 */
	@Override
